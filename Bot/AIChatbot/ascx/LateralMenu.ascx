                      ...
                      <%--  <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Tags.aspx">Select</a>
                                </li>
                                <li>
                                    <a href="TagDetail.aspx">New</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Documents.aspx">Select</a>
                                </li>
                                <li>
                                    <a href="DocumentDetail.aspx">New</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-image fa-fw"></i> Images<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Images.aspx">Select</a>
                                </li>
                                <li>
                                    <a href="ImageDetail.aspx">New</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                       <%-- <li>
                        ...
                        <%-- <li>
                            <a href="Default.aspx"><i class="fa fa-edit fa-fw"></i> Users</a>
                        </li>--%>
                          <li>
