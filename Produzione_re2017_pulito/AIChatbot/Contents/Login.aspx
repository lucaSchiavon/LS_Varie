<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AQuest.ChatBotGsk.PigeonCms.pgn_content.Contents.Login" %>
                        ...
                        <h2 style="font-weight:bold;text-align:center">LOGIN</h2>
                            ...
                            <fieldset>
                                ...
                                <div class="checkbox hidden">
                                    <label>
                                       <asp:CheckBox ID="ChkPersist" runat="server" Text="Remember Me" Visible="false" />
